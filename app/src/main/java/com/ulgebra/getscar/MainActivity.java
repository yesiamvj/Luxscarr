...
//            alert.show();
            ...
            // Toast.makeText(getApplicationContext()," Welcome to GetsCar ",Toast.LENGTH_SHORT).show();

            if(user_idd.length()>1){

                Toast.makeText(getApplicationContext()," Welcome Again to GetsCar ",Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        }  else if (id == R.id.nav_forgotPass) {
