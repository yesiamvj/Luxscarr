...
public class Ride_Overview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String car_id=intentq.getStringExtra("booking_id");
        ...
        url="http://luxscar.com/luxscar_app/OverviewRide.php?booking_id="+car_id+"&selel=vijb";
    ...
    public boolean onNavigateUp() {
        Intent returnIntent = new Intent(this,SingleBookingDetails.class);
        returnIntent.putExtra("result",1);
        setResult(RESULT_OK,returnIntent);
        finish();
        return true;
