    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra(Intent.EXTRA_SUBJECT, "Sharing GetsCar app");
                i.putExtra(Intent.EXTRA_TEXT, "Hi , Sign Up & and get discount on Booking rides on GetsCar app .Please go to http://luxscar.com/app/signUp.php?inviter="+user_idd+"&src=app");
