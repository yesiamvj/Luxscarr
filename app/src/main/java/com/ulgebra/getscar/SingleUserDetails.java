...
public class SingleUserDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button refDetBtn=(Button)findViewById(R.id.referDtl_btn);
        ...
        refDetBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),MyReferrals.class);
